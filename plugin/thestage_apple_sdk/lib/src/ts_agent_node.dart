...
///
/// Pass instances to [TSVoiceAgent.start] via `extra_nodes:`.
/// Example nodes (VLM captions, event logs) live in the host app — not here.
abstract class TSAgentNode {
  String get id;
...
class VoiceAgentNodeDispatcher {
  ...
  _publishNodeEvent;
  final Map<String, TSAgentNode> _nodes = {};

  void registerNodes(List<TSAgentNode> nodes) {
    _nodes
      ..clear()
